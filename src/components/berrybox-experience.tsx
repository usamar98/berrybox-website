  ...
  return <WalletConnectProvider><div className="site">
    ...
    <main id="top">
      <section className="hero">
        ...
        <div className="hero-content"><p className="eyebrow lime">BUILD WHAT&apos;S NEXT</p><h1><span className="hero-a">CREATE GAMES</span><span className="hero-b">Earn stocks.</span></h1><HeroStockRewards /><div className="hero-bottom"><p>BUILD GAMES WITH AI. PUBLISH THEM TO BERRYHUB. PLAY COMMUNITY-BUILT EXPERIENCES. UNLOCK STOCK-BASED REWARDS <span className="chain-highlight">BUILT ON ROBINHOOD CHAIN.</span></p><div><ConnectWalletButton className="cta button-link" /><Button variant="outline" className="ghost"><Play /> WATCH DEMO</Button></div></div></div>
      </section>
